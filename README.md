...
[![Tutorial](https://img.shields.io/badge/ChIPSeqAnalysis-blue)](https://ishaaq34.github.io/chipseq-tutorial-readthedocs/) [![Docs](https://img.shields.io/badge/docs-readthedocs-blue)](https://ishaaq34.github.io/chipseq-tutorial-readthedocs/) [![Last Updated](https://img.shields.io/badge/last%20updated-March%202026-blue)](#)
...
**03. [GEO/FASTQ Download](docs/03_geo_fastq_download.md)**
...
**04. [FASTQ Concepts & QC](docs/04_fastq_concepts.md)**
...
**05. [Alignment with Bowtie2](docs/05_alignment_bowtie2.md)**
...
**06. [Duplicate Removal & QC](docs/06_duplicate_removal_qc.md)**
...
**07. [Library Complexity Assessment](docs/07_library_complexity.md)**
...
**08. [BAM Quality Metrics](docs/08_bam_quality_metrics.md)**
...
**09. [Strand Cross-Correlation](docs/09_strand_cross_correlation.md)**
...
**10. [BAM Summary & Fingerprint Plots](docs/10_bam_summary_fingerprint.md)**
...
**11. [MACS3 Peak Calling](docs/11_macs3_peak_calling.md)**
...
**12. [FRiP Quality Metrics](docs/12_frip_quality_metrics.md)**
...
**13. [IDR & Consensus Peaks](docs/13_idr_consensus_motifs_rk_corrected.md)**
...
**14. [BigWig Generation](docs/14_bigwig_generation.md)**
...
**15. [Visualization with deepTools](docs/15_visualization_heatmaps.md)**
...
**16. [Peak Annotation with ChIPseeker](docs/16_chipseeker_annotation.md)**
